    ...
    return ReactDom.createPortal(
        ...
        >
            <div
                ...
                onClick={handleClose}
            ></div>
            <div className="modal-content bg-white relative z-10 p-10 rounded-lg max-w-[482px] w-full">
                <span
                    onClick={handleClose}
                    className="absolute top-0 right-0 flex items-center justify-center w-10 h-10 p-1 bg-white rounded-full cursor-pointer translate-x-2/4 -translate-y-2/4"
                >
                    <svg
                        width="14"
                        height="14"
                ...
                <div className="flex flex-col gap-5 mb-5">
                    ...
                    <input
                        type="text"
                        className="w-full text-sm leading-normal bg-[#e7ecfe] rounded-lg p-4"
